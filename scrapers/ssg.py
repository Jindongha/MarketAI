...
SAMPLE: List[Promotion] = [
    ...
    Promotion(id="ssg_3", platform="ssg", platform_name="SSG", title="오뚜기 3분 카레·짜장 혼합 20개 세트", original_price=22000, sale_price=13200, discount_rate=40, url="https://www.ssg.com/search/search.ssg?query=오뚜기3분", category="간편식", image_url=get_image("간편식","")),
