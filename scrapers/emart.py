...
SAMPLE: List[Promotion] = [
    Promotion(id="emart_1", platform="emart", platform_name="이마트", title="노브랜드 신라면 5개입×6묶음", original_price=16500, sale_price=11550, discount_rate=30, url="https://emart.ssg.com/search.ssg?query=노브랜드라면", category="라면", badge="SSG배송", image_url=get_image("라면","")),
